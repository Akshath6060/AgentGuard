...
export const api = {
  ...
  updatePolicy: (id, body) => request(`/v1/policies/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  deletePolicy: (id) => request(`/v1/policies/${id}`, { method: 'DELETE' }),
  indexPolicy: (id) => request(`/v1/policies/${id}/index`, { method: 'POST' }),
