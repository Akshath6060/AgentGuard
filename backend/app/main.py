...
from .api import auth,agents,policies,authorizations,transactions,approvals,audit,api_keys,dashboard,payments
...
for module in [auth,agents,policies,authorizations,transactions,approvals,audit,api_keys,dashboard,payments]:app.include_router(module.router)
@app.get("/health")
