...
async def ensure_indexes(database=None):
    ...
    await d.policies.create_index([("workspace_id", ASCENDING), ("status", ASCENDING), ("category", ASCENDING), ("updated_at", DESCENDING)])
    await d.policies.create_index([("workspace_id", ASCENDING), ("name", "text"), ("description", "text"), ("content", "text")])
    await d.policy_chunks.create_index([("workspace_id", ASCENDING), ("policy_id", ASCENDING), ("policy_version", ASCENDING), ("chunk_index", ASCENDING)], unique=True)
    await d.policy_chunks.create_index([("workspace_id", ASCENDING), ("policy_id", ASCENDING)])
    ...
    await d.decision_audits.create_index([("workspace_id", ASCENDING), ("transaction_id", ASCENDING)], unique=True)
